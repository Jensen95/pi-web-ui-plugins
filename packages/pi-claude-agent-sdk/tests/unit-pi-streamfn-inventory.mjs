...
const PI_DIST_CANDIDATES = [
	fileURLToPath(new URL("../node_modules/@earendil-works/pi-coding-agent/dist/core", import.meta.url)),
	fileURLToPath(new URL("../../node_modules/@earendil-works/pi-coding-agent/dist/core", import.meta.url)),
	fileURLToPath(new URL("../../../node_modules/@earendil-works/pi-coding-agent/dist/core", import.meta.url)),
];
const PI_DIST = PI_DIST_CANDIDATES.find(existsSync) ?? PI_DIST_CANDIDATES[0];
