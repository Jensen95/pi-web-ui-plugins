...
describe("build", () => {
	...
	it("keeps generated artifacts trackable for direct installs", () => {
		...
		expect(isGitIgnored(`plugins/${ID}/index.mjs`)).toBe(false);
		expect(isGitIgnored(`plugins/${ID}/client/entry.mjs`)).toBe(false);
